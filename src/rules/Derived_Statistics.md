...
Inputs: Strength, Weight, Weapon Mastery · Reduced by: Precision, Balance

**2. Defensive Hit Points (DHP)** — the outer health layer, absorbed before HP. Regenerates faster than HP.
Inputs: Weight, Endurance · Reduced by: Balance, Precision
...
Inputs: Dexterity, Action Priority, Control · Reduced by: Weight, Precision
...
Inputs: Dexterity, Balance, Cunning · Reduced by: Weight, Mental Fortitude
...
Inputs: Endurance, Balance, Adaptation · Reduced by: Weight, Control, Cunning

**8. Action Density** — number of sub-actions or bonus actions available per AP window.
Inputs: Action Priority, Precision, Cunning, Control · Reduced by: Weight, Mental Fortitude
...
Inputs: Wisdom, Perception, Cunning, Balance · Reduced by: Mental Fortitude
